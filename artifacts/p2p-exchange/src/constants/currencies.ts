...
export const NATIONALITY_TO_CURRENCY: Record<string, string> = {
  ...
  CA: "CAD", CH: "CHF", CL: "CLP", CN: "CNY",
  CO: "COP", CR: "CRC", CZ: "CZK", DE: "EUR",
  DK: "DKK", DO: "DOP", DZ: "DZD", EG: "EGP",
  ES: "EUR", ET: "ETB", FR: "EUR", GB: "GBP",
  GE: "GEL", GH: "GHS", GT: "GTQ", HK: "HKD",
  HN: "HNL", HR: "EUR", HU: "HUF", ID: "IDR",
  IE: "EUR", IN: "INR", IQ: "IQD", IS: "ISK",
  IT: "EUR", JO: "JOD", JP: "JPY", KE: "KES",
  KG: "KGS", KH: "KHR", KR: "KRW", KW: "KWD",
  KZ: "KZT", LA: "LAK", LB: "LBP", LK: "LKR",
  MA: "MAD", MD: "MDL", MK: "MKD", MM: "MMK",
  MN: "MNT", MO: "MOP", MX: "MXN", MY: "MYR",
  NG: "NGN", NO: "NOK", NP: "NPR", NZ: "NZD",
  OM: "OMR", PE: "PEN", PH: "PHP", PK: "PKR",
  PL: "PLN", PY: "PYG", QA: "QAR", RO: "RON",
  RS: "RSD", RU: "RUB", SA: "SAR", SD: "SDG",
  SE: "SEK", SG: "SGD", TH: "THB", TJ: "TJS",
  TM: "TMT", TN: "TND", TR: "TRY", TW: "TWD",
  TZ: "TZS", UA: "UAH", UG: "UGX", US: "USD",
  UY: "UYU", UZ: "UZS", VE: "VES", VN: "VND",
