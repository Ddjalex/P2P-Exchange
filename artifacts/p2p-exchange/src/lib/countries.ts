...
export const ET = COUNTRIES.find(c => c.code === "ET")!;
// Default dial-code selection for phone registration/login is US, per product decision.
export const DEFAULT_COUNTRY = COUNTRIES.find(c => c.code === "US")!;

export function filterCountries(q: string) {
