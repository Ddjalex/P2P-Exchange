      ...
      .values([
        {
          ...
          body: "Your account is ready. Complete KYC to unlock full trading features.",
          isRead: false,
        },
        {
          userId: devUser.id,
          type: "kyc",
          title: "KYC Verified",
          body: "Your identity has been verified. You can now trade without limits.",
          isRead: false,
        },
        {
          userId: devUser.id,
          ...
          body: "Biruk Haile placed an order on your sell ad. Check your orders.",
          isRead: false,
        },
      ])
      .onConflictDoNothing();
